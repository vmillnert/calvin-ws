...
if __name__ == "__main__":
    ...
    curi1 = 'localhost:5001'
    curi2 = 'localhost:5003'
    curi3 = 'localhost:5005'
    curi4 = 'localhost:5007'
    ...
    edge1 = HealthPusher(curi1)
    edge2 = HealthPusher(curi2)
    edge3 = HealthPusher(curi3)
    dc = HealthPusher(curi4)

    # move to cell 1
    edge1.set_imei_cells([{"imei": imei, "cell": cell1}])
    edge2.set_imei_cells([{"imei": imei, "cell": cell1}])
    edge3.set_imei_cells([{"imei": imei, "cell": cell1}])
    dc.set_imei_cells([{"imei": imei, "cell": cell1}])

    time.sleep(wait)

    # move to cell 2
    edge1.set_imei_cells([{"imei": imei, "cell": cell2}])
    edge2.set_imei_cells([{"imei": imei, "cell": cell2}])
    edge3.set_imei_cells([{"imei": imei, "cell": cell2}])
    dc.set_imei_cells([{"imei": imei, "cell": cell2}])

    time.sleep(wait)

    # set bad health on cell 2    
    edge2.set_health(bad)
    time.sleep(2)
    edge2.set_health(bad)
    ...
    # move to cell 3
    edge1.set_imei_cells([{"imei": imei, "cell": cell3}])
    edge2.set_imei_cells([{"imei": imei, "cell": cell3}])
    edge3.set_imei_cells([{"imei": imei, "cell": cell3}])
    dc.set_imei_cells([{"imei": imei, "cell": cell3}])
    ...
    # set good health on cell 2
    edge2.set_health(good)
